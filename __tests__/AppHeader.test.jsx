...
describe('AppHeader', () => {
  it('renders with title', () => {
    const { getByText } = renderWithTheme(<AppHeader title="Test Title" />);
  ...
  it('renders with left icon', () => {
    const { getByTestId } = renderWithTheme(
      <AppHeader title="Test Title" leftIcon={<div testID="left-icon" />} />,
    );
  ...
  it('renders with right icon', () => {
    const { getByTestId } = renderWithTheme(
      <AppHeader title="Test Title" rightIcon={<div testID="right-icon" />} />,
    );
  ...
  it('applies custom background color', () => {
    const { getByTestId } = renderWithTheme(
      <AppHeader title="Test Title" background="#FF0000" testID="header" />,
    );
