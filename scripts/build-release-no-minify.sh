...
# Android Release Build Script (No Minification)
# This script builds a release APK without minification to avoid R8 errors

set -e  # Exit on any error

echo "🚀 Starting Android Release Build (No Minification)..."
...
# Temporarily disable minification in build.gradle
print_status "Temporarily disabling minification..."
...
# Build release APK
print_status "Building release APK (no minification)..."
cd android
./gradlew assembleRelease
cd ..

# Re-enable minification for future builds
print_status "Re-enabling minification for future builds..."
