...
const CitySelectionScreen = ({ navigation }) => {
  ...
  const handleContinue = async () => {
    if (!selectedCity) {
      Alert.alert('Please select a city', 'You need to choose your preferred city to continue.');
      return;
    }
    ...
    try {
      ...
      Alert.alert('Error', 'Failed to update your city preference. Please try again.');
    } finally {
      setIsLoading(false);
    }
  };
        ...
        <Animated.View style={[styles.content, { transform: [{ scale: scaleAnim }] }]}>
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>
              Select your preferred city to find relevant job opportunities in your area
            </Text>
          </View>
                  ...
                  <View style={styles.cityCardContent}>
                    ...
                    {selectedCity === city.id && (
                      <View style={styles.selectedIndicator}>
                        <Feather name="check-circle" size={24} color={city.color[0]} />
                      </View>
                    )}
                  </View>
                </Card>
